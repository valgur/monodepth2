...
from hubconf import ResnetEncoder, DepthDecoder
...
def test_simple(args):
    ...
    encoder = ResnetEncoder(args.model_name, map_location=device)
    encoder.to(device)
    depth_decoder = DepthDecoder(args.model_name, map_location=device)
